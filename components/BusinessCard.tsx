...
export function BusinessCard() {
  ...
  return (
    <div className="relative overflow-hidden md:overflow-visible rounded-2xl bg-[#F0EDE5] dark:bg-[#242626] px-12 pt-12 md:px-16 md:pt-16">
      {/* Dot pattern overlay */}
      <div
        aria-hidden
      ...
      {/* Photo — absolute, ~40% sticks out left of the card on desktop */}
      <div
        aria-hidden
        className="hidden md:flex absolute left-[-80px] top-1/2 -translate-y-1/2 z-10 w-[200px] h-[200px] rounded-full overflow-hidden border-2 border-neutral-200/20 bg-neutral-300 dark:bg-neutral-600 items-center justify-center"
      >
        <span className="text-xs text-neutral-400">Photo</span>
      </div>

      <div className="relative md:pl-[140px]">
        {/* Heading */}
