...
export function UnderConstruction() {
  ...
  return (
    ...
    >
      ...
      <div
        className="wip-tape-scroll absolute -right-[70px] bottom-[54px] flex h-8 w-[280px] rotate-[-45deg] items-center justify-center shadow-[0_2px_14px_rgba(0,0,0,0.28)] md:-right-[100px] md:bottom-[78px] md:h-11 md:w-[400px]"
        style={{
          backgroundImage:
            "repeating-linear-gradient(45deg, #FFD500 0 14px, #101010 14px 28px)",
        }}
      >
        <span className="whitespace-nowrap bg-[#101010] px-3 py-[3px] font-mono text-[8px] font-medium uppercase tracking-[0.24em] text-[#FFD500] md:px-4 md:py-1 md:text-[11px] md:tracking-[0.3em]">
          {/* Negative end margin cancels the trailing letter-space so the
              label sits optically centred on the tape. */}
          <span className="-mr-[0.24em] inline-block md:-mr-[0.3em]">
            Under construction
          </span>
        </span>
      </div>
