...
export function GalleryCard() {
  return (
    <a
      href="/other"
      className="group relative block h-[348px] md:h-[248px] rounded-2xl bg-white dark:bg-cream-warm border border-stone-200/60 shadow-[0_-2px_24px_rgba(0,0,0,0.06)] dark:shadow-[0_-2px_24px_rgba(0,0,0,0.35)] p-5 transition-transform duration-200 hover:-translate-y-0.5"
    >
      <ArrowUpRight
        size={32}
        strokeWidth={1.5}
      ...
      <div className="flex flex-col md:flex-row-reverse gap-3 md:gap-5 h-full">
        <div className="md:flex-1 md:min-w-0 flex flex-col pr-10">
          ...
          <h3 className="mt-3 font-sans font-semibold text-[28px] md:text-[32px] leading-[1.1] tracking-tight text-[#171717] dark:text-[#ededed]">
