      ...
      <main>
        ...
        <section id="cases" className="px-6 md:px-10 mb-32 scroll-mt-[16.6667vh]">
          <div className="max-w-[1080px] mx-auto">
            <h2 className="mb-8 font-sans font-semibold text-4xl md:text-5xl tracking-tight text-[#282726] dark:text-[#E8E8E6]">
              Cases
            </h2>
          </div>
                ...
                >
                  ...
                  <div className="flex flex-col md:flex-row-reverse gap-3 md:gap-5 h-full">
                    <div className="md:flex-1 md:min-w-0 flex flex-col pr-10">
                      ...
                      <h3 className="mt-3 font-sans font-semibold text-[28px] md:text-[32px] leading-[1.1] tracking-tight text-[#282726] dark:text-[#E8E8E6]">
                        {c.title}
                      </h3>
